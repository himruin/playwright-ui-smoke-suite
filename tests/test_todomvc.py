...
class TestTodoInteractions:
    ...
    @pytest.mark.parametrize(
        "task_text", ["buy milk", "learn playwright", "code review"]
    )  # noqa: E501
    ...
    def test_complete_task(self, task_page, task_text):
        ...
        expect(task_page.tasks_items.filter(has_text=task_text)).to_have_class(
            "completed"
        )  # noqa: E501
    ...
    def test_complete_workflow(self, task_page):
        ...
        expect(task_page.tasks_items.filter(has_text=edited_text)).to_have_class(
            "completed"
        )  # noqa: E501
...
class TestFilters:
    ...
    def test_active_filter(self, task_page):
        ...
        expect(
            task_page.tasks_items.filter(has_text="learn playwright")
        ).to_be_visible()  # noqa: E501
    ...
    def test_completed_filter(self, task_page):
        ...
        expect(task_page.tasks_items.filter(has_text="learn playwright")).to_have_count(
            0
        )  # noqa: E501
